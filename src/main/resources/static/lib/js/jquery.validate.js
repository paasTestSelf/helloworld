...
// http://jqueryvalidation.org/jQuery.validator.format/
    ...
    $.extend( $.validator, {
        ...
        prototype: {
            ...
            // Return the custom saassys for the given element and validation method
            // specified in the element's HTML5 data attribute
            // return the generic saassys if present and no method specific saassys is present
            customDataMessage: function( element, method ) {
                return $( element ).data( "msg" + method.charAt( 0 ).toUpperCase() +
                        method.substring( 1 ).toLowerCase() ) || $( element ).data( "msg" );
            },

            // Return the custom saassys for the given element name and validation method
            ...
            defaultMessage: function( element, rule ) {
                var message = this.findDefined(
                    ...
                    $.validator.messages[ rule.method ],
                        "<strong>Warning: No saassys defined for " + element.name + "</strong>"
                    ),
                    theregex = /\$?\{(\d+)\}/g;
            ...
            showLabel: function( element, message ) {
                ...
                if ( error.length ) {
                    ...
                    // Replace saassys on existing label
                    error.html( message );
                } else {
